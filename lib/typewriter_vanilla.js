(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("typewriter_vanilla", [], factory);
	else if(typeof exports === 'object')
		exports["typewriter_vanilla"] = factory();
	else
		root["typewriter_vanilla"] = factory();
})(this, function() {
...
var toSubscriber_1 = __webpack_require__(58);
...
var _random = __webpack_require__(98);
...
exports.default = function (_ref) {
  var min = _ref.min,
      _ref$max = _ref.max,
      max = _ref$max === undefined ? min : _ref$max;

  var i = 0;

  return _Observable.Observable.of('').switchMap(function () {
    return _Observable.Observable.timer((0, _random2.default)(min, max));
  }).repeat().map(function (_) {
    return i++;
  });
};
...
var _randomTimer = __webpack_require__(31);

var _randomTimer2 = _interopRequireDefault(_randomTimer);
...
exports.default = function (_ref) {
  var word = _ref.word,
      _ref$min = _ref.min,
      min = _ref$min === undefined ? 100 : _ref$min,
      max = _ref.max;
  return (0, _randomTimer2.default)({ min: min, max: max }).take(word.length).map(function (x) {
    return word.substr(0, x + 1);
  });
};
...
exports.default = function () {
  var pattern = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [200, 800, 400, 800, 200];
  ...
  return _Observable.Observable.of(empty).concat(_Observable.Observable.from(pattern).concatMap(function (duration, index) {
    return _Observable.Observable.timer(duration).map(function () {
      return index % 2 ? empty : character;
    });
  }
...
var _word = __webpack_require__(38);
...
exports.default = function (words) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { loop: true, cursorWhileTyping: '|' },
      loop = _ref.loop,
      cursorWhileTyping = _ref.cursorWhileTyping;

  var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      _ref2$cursorCharacter = _ref2.cursorCharacter,
      cursorCharacter = _ref2$cursorCharacter === undefined ? cursorWhileTyping : _ref2$cursorCharacter,
      cursorPattern = _ref2.cursorPattern;

  var words$ = _Observable.Observable.from(words).concatMap(function (word) {
    return (0, _word2.default)({ word: word })
    // Append the cursor while typing string to the current text
    .map(function (text) {
      return '' + text + cursorWhileTyping;
    }).concat(
    // Append the cursor to the full word
    (0, _cursor2.default)().map(function (text) {
      return '' + word + text;
    }));
  });
...
var identity = __webpack_require__(15),
    metaMap = __webpack_require__(45);
...
var WeakMap = __webpack_require__(122);
...
var composeArgs = __webpack_require__(47),
    composeArgsRight = __webpack_require__(48),
    countHolders = __webpack_require__(125),
    createCtor = __webpack_require__(6),
    createRecurry = __webpack_require__(49),
    getHolder = __webpack_require__(20),
    reorder = __webpack_require__(141),
...
var isLaziable = __webpack_require__(126),
    setData = __webpack_require__(54),
    setWrapToString = __webpack_require__(55);
...
var metaMap = __webpack_require__(45),
...
var getWrapDetails = __webpack_require__(132),
    insertWrapDetails = __webpack_require__(133),
...
exports.input = exports.cursor = exports.word = exports.randomTimer = exports.typewriter = undefined;
...
var _typewriter = __webpack_require__(40);
...
exports.randomTimer = _randomTimer2.default;
exports.word = _word2.default;
exports.cursor = _cursor2.default;
exports.input = _input2.default; // Rxjs stuff we need
...
var IteratorObservable_1 = __webpack_require__(64);
...
var TimerObservable_1 = __webpack_require__(72);
...
var Observable_1 = __webpack_require__(0);
var concatMap_1 = __webpack_require__(85);
...
var Observable_1 = __webpack_require__(0);
var repeat_1 = __webpack_require__(94);
...
var Observable_1 = __webpack_require__(0);
var take_1 = __webpack_require__(96);
...
var baseRandom = __webpack_require__(99),
    isIterateeCall = __webpack_require__(100),
    toFinite = __webpack_require__(36);
...
var _bind = __webpack_require__(110);
...
exports.default = function (element, words, _ref, wordOptions, characterOptions) {
  var _ref$writeTo = _ref.writeTo,
      writeTo = _ref$writeTo === undefined ? 'placeholder' : _ref$writeTo,
      _ref$autoStart = _ref.autoStart,
      autoStart = _ref$autoStart === undefined ? false : _ref$autoStart,
      _ref$restartOnBlur = _ref.restartOnBlur,
      restartOnBlur = _ref$restartOnBlur === undefined ? true : _ref$restartOnBlur;

  var text$ = (0, _typewriter2.default)(words, wordOptions, characterOptions);

  var write = (0, _bind2.default)(element.setAttribute, element, writeTo);
  ...
  var input = {
    ...
    start: function start() {
      return subscription = text$.subscribe(function (text) {
        return write(text);
      });
    },
    stop: function stop() {
  ...
  if (restartOnBlur) {
    element.addEventListener('focus', function () {
      return input.stop() || input.clear();
    });
    element.addEventListener('blur', function () {
      return (element.getAttribute('value') ? _noop2.default : input.start)();
    });
  }
...
var baseRest = __webpack_require__(111),
    createWrap = __webpack_require__(121),
    getHolder = __webpack_require__(20),
    replaceHolders = __webpack_require__(7);
...
var baseSetData = __webpack_require__(44),
    createBind = __webpack_require__(123),
    createCurry = __webpack_require__(124),
    createHybrid = __webpack_require__(46),
    createPartial = __webpack_require__(142),
    getData = __webpack_require__(50),
    mergeData = __webpack_require__(143),
    setData = __webpack_require__(54),
    setWrapToString = __webpack_require__(55),
...
var createCtor = __webpack_require__(6),
    root = __webpack_require__(3);
...
var LazyWrapper = __webpack_require__(18),
    ...
    lodash = __webpack_require__(129);
...
var realNames = __webpack_require__(128);
...
var LazyWrapper = __webpack_require__(18),
    ...
    isObjectLike = __webpack_require__(37),
    wrapperClone = __webpack_require__(131);
...
//# sourceMappingURL=typewriter_vanilla.js.map